...
<form action="settings.php" method="Post" enctype="multipart/form-data">
    ...
    <v-text-field name="new_pass" v-model="new_pass" label="New Password" prepend-icon="mdi-lock" required></v-text-field>
    <div class="editprofile-btns">
        <button class="update-btn" type="submit" name="chg_pass_btn">Change</button>
