...
<div class="editprofile-wrap">
  <div class="profile">
      ...
      <div class="update-link-text">Basic Info</div>
		...
		<v-text-field name="ind_name" v-model="ind_name" label="Industry Name" prepend-icon="mdi-factory" required></v-text-field>
		<v-text-field name="training_field" v-model="training_field" label="Field of Training" prepend-icon="mdi-domain" required></v-text-field> 
    ...
    <v-text-field name="proj_startdt" v-model="proj_startdt" label="Date of Commencement" prepend-icon="mdi-calendar-range" type="date" required></v-text-field>
		<v-text-field name="proj_enddt" v-model="proj_enddt" label="Date of Completion (If Completed)" prepend-icon="mdi-calendar-range" type="date" required></v-text-field>
    ...
    <div class="editprofile-btns">
        <button class="update-btn" type="submit" name="newit_btn">Post</button>
