...
<div class="editprofile-wrap">
  <div class="profile">
      ...
      <div class="update-link-text">Basic Info</div>
		...
		<v-text-field name="proj_domain" v-model="proj_domain" label="Domain" prepend-icon="mdi-domain" required></v-text-field>
		<v-text-field name="proj_members" v-model="proj_members" label="Members (Separated by Comma)" prepend-icon="mdi-account-group" required></v-text-field>
    <v-select name="spon_by" v-model="s_spon_by" :items="spon_bys" label="Sponsored by" prepend-icon="mdi-account-supervisor-circle" required></v-select>
		...
		<v-text-field name="proj_cost" v-model="proj_cost" label="Project Cost (INR)" prepend-icon="mdi-currency-usd" required></v-text-field>
		<v-text-field name="proj_startdt" v-model="proj_startdt" label="Date of Commencement" prepend-icon="mdi-calendar-range" type="date" required></v-text-field>
		<v-select name="proj_status" v-model="s_proj_status" :items="proj_statuss" label="Project Status" prepend-icon="mdi-list-status" required></v-select>
		<v-text-field name="proj_enddt" v-model="proj_enddt" label="Date of Completion (If Completed)" prepend-icon="mdi-calendar-range" type="date"></v-text-field>
    ...
    <div class="editprofile-btns">
        <button class="update-btn" type="submit" name="newproject_btn">Post</button>
  ...
  <script>
    new Vue({
      ...
      data:{
            ...
            //New Post
            s_proj_status:'',
            proj_statuss:['Under Development','Completed'],
            s_spon_by:'',
            spon_bys:['Self','Other']
      },
      methods: {
