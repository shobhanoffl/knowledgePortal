...
(function($) {
    ...
    function ssubmitForm() {
        ...
        $.ajax({
            ...
            data: "clgid=" + clgid + "&name=" + name + "&password=" + password + "&terms=" + terms, 
    ...
    function lsubmitForm() {
        // initiate variables with form content
		var clgid = $("#lclgid").val();
		var password = $("#lpassword").val();
        
        $.ajax({
            type: "POST",
            url: "php/loginform-process.php",
            data: "clgid=" + clgid + "&password=" + password, 
            success: function(text) {
                if (text == "success") {
                    lformSuccess();
                } else {
    ...
    function nsubmitForm() {
        // initiate variables with form content
		var clgid = $("#nclgid").val();
        var terms = $("#nterms").val();
        $.ajax({
            type: "POST",
            url: "php/newsletterform-process.php",
            data: "clgid=" + clgid + "&terms=" + terms, 
            success: function(text) {
                if (text == "success") {
                    nformSuccess();
                } else {
    ...
    function psubmitForm() {
        ...
        $.ajax({
            ...
            data: "name=" + name + "&clgid=" + clgid + "&select=" + select + "&terms=" + terms, 
            success: function(text) {
                if (text == "success") {
                    pformSuccess();
                } else {
